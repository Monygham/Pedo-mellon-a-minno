...
\noindent
These notes are devoted to advanced notions in measure theory. Tools presented here are indispensable in probability theory, statistics and applications to geometry. We refer to \cite{Introduction_to_measure_theory} for basic measure theory and to \cite{Integration} for integration theory.
