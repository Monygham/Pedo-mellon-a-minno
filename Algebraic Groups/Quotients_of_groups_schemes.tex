...
\noindent
We start by discussing some preliminary result concerning $\bd{G}$-linearizations of quasi-coherent sheaves.
...
$$=\left(\mathrm{pr}_{23}^*\tau \cdot \left(1_{\bd{G}}\times_ka\right)^*\tau\right)\left(\left(1_{\bd{G}}\times_ka\right)^*a^*s\right)$$
\end{proof}
