...
\lstodo{Tu trzeba zdefiniować i następnie opisać przypadek schematu z lokalnie liniowym działaniem, bo on jest najważniejszy}
...
\begin{proof}
\lstodo{Locally noetherian trzeba włączyć i jechać z koksami dalej}
