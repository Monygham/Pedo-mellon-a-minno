...
\begin{corollary}[Compactness for $\vDash$]\label{theorem:compactness_without_identity}
...
\begin{corollary}[Compactness for $\vDash_I$]\label{theorem:compactness_for_languages_with_identity}
